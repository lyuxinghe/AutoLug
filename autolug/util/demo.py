...
class YOLO:
    def __init__(self, model_name: str, device: Optional[str] = None):
        ...
        # load model
        self.model = torch.hub.load('ultralytics/yolov5', 'custom', 'weights/yolov5n.engine')
...
for input_path in args.files:
    if input_path.isnumeric():
        video = Video(camera=int(input_path))
    else:
        video = Video(input_path=input_path)

    distance_function = "iou" if args.track_points == "bbox" else "mean_euclidean"
    distance_threshold = (
